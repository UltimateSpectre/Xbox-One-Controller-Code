## Project Overview: Accessible Xbox One Controller

This project focused on designing a specialized Xbox One controller for a user with cerebral palsy, emphasizing adaptable design, accessibility, and user-centered innovation.

The main objective was to create a controller that was functional, affordable, and easy to use. The final design included waterproofing, customized joystick controls, and accessible button features. While the controller successfully addressed several of the user’s needs, the lack of wireless functionality remained a limitation and highlighted an area for future improvement.
...
![IMG_0172](https://github.com/user-attachments/assets/37408bd3-149f-4685-9ad3-d02dedd3ec61)
